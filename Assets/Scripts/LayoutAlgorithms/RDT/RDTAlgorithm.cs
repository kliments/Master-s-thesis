...
/*
 * Implements RDT (Reconfigurable Disk Trees) algorithm for reduction of edge crossings
 */
public class RDTAlgorithm : GeneralLayoutAlgorithm
{
    public float height;
